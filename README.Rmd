...
knitr::include_graphics("inst/reviewer-sc.png")
```
...
By default, `review()` uses Claude Sonnet 4. To change models, provide a `provider/model` string in the same manner you would to [`ellmer::chat()`](https://ellmer.tidyverse.org/reference/chat-any.html) to the `model` argument:
