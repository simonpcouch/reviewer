# new_reviewer_chat() errors when no option or model provided
    ...
    Condition
      ...
      i Set e.g. `options(reviewer.chat = ellmer::chat_claude("claude-sonnet-4-5"))` in your '~/.Rprofile' and restart R.
...
# new_reviewer_chat() errors for invalid option type
    ...
    Condition
      ...
      i Set e.g. `options(reviewer.chat = ellmer::chat_claude("claude-sonnet-4-5"))` or `options(reviewer.chat = "openai/gpt-5")` in your '~/.Rprofile'.
